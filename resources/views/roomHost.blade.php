...
<div id="copy-url-white" class="input-group mb-2 w-50 mx-auto" data-toggle="tooltip" data-placement="bottom" data-original-title="Click to copy">
  <div class="input-group-prepend">
    <span class="input-group-text font-weight-bold" id="url-addon">WHITE</span>
  </div>
  <input type="text" class="form-control" id="url-white" aria-describedby="url-addon" value="{{ url('/') }}/room/{{ $roomCode }}/white" />
</div>
<div id="copy-url-black" class="input-group mb-2 w-50 mx-auto" data-toggle="tooltip" data-placement="bottom" data-original-title="Click to copy">
  <div class="input-group-prepend">
    <span class="input-group-text font-weight-bold" id="url-addon">BLACK</span>
  </div>
  <input type="text" class="form-control" id="url-black" aria-describedby="url-addon" value="{{ url('/') }}/room/{{ $roomCode }}/black" />
</div>
<p class="w-100 text-center mt-2">
  <span class="side-color">WHITE</span>
</p>
@endsection
